        ...
        <div className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center bg-[rgba(138,138,140,255)] h-screen'>
            ...
            <div className='bg-white md:text-base lg:text-lg  rounded-2xl shadow-2xl flex w-2/3 h-2/3 '>
                ...
                <div className='w-2/5 p-5'>
                    ...
                    <div className='flex flex-col items-center  lg:mt-[10%] lg:mb-[10%] md:mt-[5%] md:mb-[10%]'>
                        <div className='w-[100%] bg-gray-200 md:p-[6px] lg:p-2 rounded-lg md:text-xs lg:text-sm items-center flex ' >
                            ...
                            <input type="email" name='email' placeholder='Email' onChange={(text) => setUsername(text.target.value)} className='bg-gray-200 md:text-xs outline-none lg:text-sm  flex-1 w-[100%] text-slate-700' />
                    ...
                    <div className='w-[100%]  '>
                        ...
                        <div className='flex justify-center'>
                            ...
                            <div onClick={handleSubmit} className='border-2 select-none border-slate-700 text-slate-700 rounded-full md:px-8 lg:px-12 md:py-2 lg:py-2  font-semibold hover:bg-slate-700 hover:text-white '>
                                Sign In
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-[75%] rounded-tr-2xl rounded-br-2xl relative'>
                    <img src="/login1.jpg" alt="Image" className='h-full w-full rounded-tr-2xl rounded-br-2xl' />
                    {/* <NextImage
                        src='/login1.jpg'
                        alt='/'
                        layout='fill'
