            ...
            <div className=' h-[100%] flex'>
                ...
                <div className='w-[20%] h-full border-gray-600  border-2'>
                    ...
                    <div className='flex h-[5%] items-center mt-[5%] ' >
                        ...
                        <div onClick={() => { setCamera(!camera) }} className='h-[70%] w-[15%]  ml-[15%]'> <Toggle toggleState={camera}  /> </div>
                    </div>

                    {/* containter containing text and toggle for Detection  */}
                    <div className='flex h-[5%] items-center mt-[5%] ' >
                        <div className='ml-[10%] text-base w-[50%]'> Detection </div>
                        <div onClick={() => { setDetection(!detection) }} className='h-[70%] w-[15%]  ml-[15%]'> <Toggle toggleState={detection} /> </div>
                    </div>
                    {/* containter containing text and toggle for Tracking  */}
                    <div className='flex h-[5%] items-center mt-[5%] ' >
                        <div className='ml-[10%] text-base w-[50%]'> Tracking </div>
                        <div onClick={() => { setTracking(!tracking) }} className='h-[70%] w-[15%]  ml-[15%]'> <Toggle toggleState={tracking} /> </div>
                    </div>
                ...
                <div className='w-[60%]  border-y-gray-600 border-x-slate-50 border-2 '>
                    ...
                    {
                        (camera)
                            ? <div className="h-[90%] bg-slate-300 border-y-2 border-gray-600 "><LiveStream formData={formData}/></div>
                            : <div className="h-[90%] bg-slate-300 border-t-2  border-gray-600 text-center text-2xl"><FileUpload /></div>
                    }
